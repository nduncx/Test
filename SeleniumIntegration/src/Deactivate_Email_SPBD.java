...
public class Deactivate_Email_SPBD extends TestCase implements IConstantes {  
...
public void testDeactivateemail() throws Exception {
	...
	selenium.waitForPageToLoad("30000");
	selenium.type("name=emailAddress", "nicholas.mcmahon@gtechg2.com");
	selenium.click("//tr[6]/td[3]/a/img");
	selenium.waitForPageToLoad("500000");
	selenium.click("id=emailAddressinfo");
	selenium.click("name=disableEmailID");
	assertTrue(selenium.getConfirmation().matches("^Do you want to disable Email address[\\s\\S]$"));
...
ResultadoExecucao.reportTestCaseResult1(PROJETO, PLANO, CASO_TESTE5, BUILD, nota, resultado);
}
}
